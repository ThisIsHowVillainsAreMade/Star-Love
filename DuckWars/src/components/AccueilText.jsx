...
function AccueilText() {
  ...
  const handleButtonClick = () => {
    ...
    <div className="scroll-text">
      ...
      <br/><p>le héros, brûlant de rage et d'un désir de justice, se dresse seul contre l'empire de l'ombre. Sa mission est de sauver son âme sœur, arrachée à son monde par les sinistres agents de Dark Quack. Son cœur, autrefois plein d'amour et de joie, est maintenant consumé par le feu de la vengeance.</p>
      <br/><p>Armé de son courage et d'une détermination inébranlable, le héros se rend sur Nar Shaddaa, la lune infâme des contrebandiers. Ce lieu où les hors-la-loi et les parias règnent en maîtres, devient le théâtre de sa quête désespérée. C'est ici que le héros espère trouver les outils et les alliés nécessaires pour défier l'Empire.</p>
      <br/><p>Sur Nar Shaddaa, le héros plonge dans les profondeurs du web galactique. Dans les entrailles du réseau, il découvre le Darkweb galactique, une mine d'informations cachées et de ressources interdites…</p>
